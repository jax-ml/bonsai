...
PERM_CONV2D_TO_NNX = (2, 3, 1, 0)
PERM_CONV2D_TRANSPOSE_TO_NNX = (2, 3, 0, 1)
PERM_LINEAR_TO_NNX = (1, 0)
...
def _get_key_and_transform_mapping():
    ...
    sam_mask_decoder = {
        ...
        r"^sam_mask_decoder\.output_upscaling\.0\.weight$": (
            ...
            (PERM_CONV2D_TRANSPOSE_TO_NNX, None),
        ),
    ...
    global_mapping = {
        ...
        # Mask Downsample
        r"^mask_downsample\.weight$": ("mask_downsample.kernel", (PERM_CONV2D_TO_NNX, None)),
        r"^mask_downsample\.bias$": ("mask_downsample.bias", None),
        # Object Pointer Projection MLP
        r"^obj_ptr_proj\.layers\.0\.weight$": ("obj_ptr_proj.layers.0.kernel", (PERM_LINEAR_TO_NNX, None)),
        r"^obj_ptr_proj\.layers\.0\.bias$": ("obj_ptr_proj.layers.0.bias", None),
        r"^obj_ptr_proj\.layers\.1\.weight$": ("obj_ptr_proj.layers.1.kernel", (PERM_LINEAR_TO_NNX, None)),
        r"^obj_ptr_proj\.layers\.1\.bias$": ("obj_ptr_proj.layers.1.bias", None),
        r"^obj_ptr_proj\.layers\.2\.weight$": ("obj_ptr_proj.layers.2.kernel", (PERM_LINEAR_TO_NNX, None)),
        r"^obj_ptr_proj\.layers\.2\.bias$": ("obj_ptr_proj.layers.2.bias", None),
        # Object TPos Encoding
        r"^obj_ptr_tpos_proj\.weight$": ("obj_ptr_tpos_proj.kernel", (PERM_LINEAR_TO_NNX, None)),
