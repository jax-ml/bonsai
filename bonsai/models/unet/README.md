...
This directory contains a pure JAX implementation of the [U-Net](https://arxiv.org/abs/1505.04597) with padded convolutions in its DoubleConv module, using the [Flax NNX](https://flax.readthedocs.io/en/stable/index.html) API.
