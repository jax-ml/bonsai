...
* **Image segmentation**: [SAM2](bonsai/models/sam2), [U-Net](bonsai/models/unet)...
* **Image classification**: [ResNet50](bonsai/models/resnet50), [Efficientnet](bonsai/models/efficientnet), ...
